export const PRIVACY_POLICY_TITLE = {
  ...
  text: [
    `Receipt Hub (“we,” “our,” or “us”) is committed to protecting your
  privacy. This Privacy Policy explains how your personal information is
  collected, used, and disclosed by Receipt Hub.`,
    ...
    Receipt Hub. By accessing or using our Service, you signify that you
...
export const PRIVACY_POLICY = [
  {
    ...
    value: [
      ...
      `  -Country: where Receipt Hub or the owners/founders of
      Receipt Hub are based, in this case is United Kingdom`,
      `  -Customer: refers to the company, organization or person
      that signs up to use the Receipt Hub Service to manage the relationships
      with your consumers or service users.`,
      `  -Device: any internet connected device such as a phone,
      tablet, computer or any other device that can be used to visit Receipt
      Hub and use the services.`,
      ...
      Receipt Hub or are under contract to perform a service on behalf of one
      of the parties.`,
      ...
      of a natural person.`,
      `  -Service: refers to the service provided by Receipt Hub as
      ...
      `  -Website: Receipt Hub."’s" site, which can be accessed via
      this URL: www.receipthub.co.uk`,
      `  -You: a person or entity that is registered with Receipt Hub
      to use the Services.`,
    ],
  },
  {
    ...
    value: [
      ...
      allows the user to upload any picture from their photo gallery, you can
      safely deny photo gallery access for this website/app.`,
    ],
  },
  {
    ...
    value: [
     ...
     following ways:`,
      ...
      `  -To improve our website/app (we continually strive to
        improve our website/app offerings based on the information and feedback
        we receive from you)`,
  ...
  {
    title: 'When does Receipt Hub use end user information from third parties?',
    value: [
      `Receipt Hub will collect End User Data necessary to provide the Receipt
     Hub services to our customers.`,
  ...
  {
    title: 'When does Receipt Hub use customer information from third parties?',
    value: [
     ...
     in becoming a Receipt Hub customer, we receive information from a third
     party that provides automated fraud detection services to Receipt Hub.
  ...
  },
  {
    ...
    value: [
      `Receipt Hub will collect personal information that you submit to us. We
  ...
  },
  {
    ...
    value: [
      `We keep your information only so long as we need it to provide Receipt
     Hub to you and fulfill the purposes described in this policy. This is
  ...
  },
  {
    ...
    value: [
      ...
      any information you transmit to Receipt Hub or guarantee that your
  ...
  },
  {
    ...
    value: [
      `Receipt Hub is incorporated in United Kingdom. Information collected via
  ...
  {
    title:
      'Is the information collected through the Receipt Hub Service secure?',
    value: [
  ...
  },
  {
    ...
    value: [
      ...
      Receipt Hub collects depend on your relationship with Receipt Hub.
  ...
  },
  {
    title: 'Personnel',
    value: [
      `If you are a Receipt Hub worker or applicant, we collect information you
  ...
  },
  {
    ...
    value: [
     ...
     the assets of Receipt Hub or any of its Corporate Affiliates (as defined
     herein), or that portion of Receipt Hub or any of its Corporate
  ...
  },
  {
    ...
    value: [
      ...
      Receipt Hub, whether by ownership or otherwise. Any information relating
  ...
  },
  {
    ...
    value: [
      ...
      international laws.`,
      `By using Receipt Hub or contacting us directly, you signify your
  ...
  },
  {
    ...
    value: [
      ...
      contain links to other websites not operated or controlled by Receipt
      Hub. We are not responsible for the content, accuracy or opinions
  ...
  },
  {
    title: 'Cookies',
    value: [
      `Receipt Hub uses "Cookies" to identify the areas of our website that you
  ...
  },
  {
    ...
    value: [
      ...
      `You acknowledge and agree that Receipt Hub shall not be responsible for
      ...
      or any other aspect thereof. Receipt Hub does not assume and shall not
  ...
  },
  {
    ...
    a custom map, a searchable map, check-in functions, display live data
    ...
    few.`,
      ...
      of our website/app but are non-essential to their use. However, without
      ...
      `  -Sessions`,
      `  Receipt Hub uses "Sessions" to identify the areas of our
  ...
  {
    title: `The Data Protection Principles include requirements such as:`,
    value: [
      `  -Personal data collected must be processed in a fair, legal,
      and transparent way and should only be used in a way that a person would
      reasonably expect.`,
      `  -Personal data should only be collected to fulfil a specific
      purpose and it should only be used for that purpose. Organizations must
  ...
  },
  {
    ...
    value: [
      ...
      At Receipt Hub we strongly believe that your data privacy is very
  ...
  },
  {
    ...
    value: [
      ...
      requirements of GDPR. Receipt Hub processes or stores all personal data
