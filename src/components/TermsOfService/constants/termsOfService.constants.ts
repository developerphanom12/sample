export const TERMS = [
  {
    title: 'General Terms',
    value: [
      `By accessing and placing an order with Receipthub, you confirm that you
  ...
  Receipthub.`,
      `Under no circumstances shall Receipthub team be liable for any direct,
  ...
  inability to use, the materials on this site, even if Receipthub team or
  ...
  costs thereof.`,
      `Receipthub will not be responsible for any outcome that may occur during
  ...
  },
  {
    title: 'License',
    value: [
      `Receipthub grants you a revocable, non-exclusive, non-transferable,
limited license to download, install and use the website/app strictly in
accordance with the terms of this Agreement.`,
      `These Terms & Conditions are a contract between you and Receipthub
(referred to in these Terms & Conditions as "Receipthub", "us", "we" or
"our"), the provider of the Receipthub website and the services
accessible from the Receipthub website (which are collectively referred
to in these Terms & Conditions as the "Receipthub Service").`,
      `You are agreeing to be bound by these Terms & Conditions. If you do not
agree to these Terms & Conditions, please do not use the Receipthub
...
access to your account without notice.`,
  ...
  preference or login information.`,
    ...
    or “our,” it refers to Webwheel Technologies Ltd, (27 Old Gloucester
    Street, London, United Kingdom, WC1N 3AX) that is responsible for your
    information under this Terms & Conditions.`,
      `  -Country: where Receipthub or the owners/founders of
    Receipthub are based, in this case is United Kingdom`,
      `  -Device: any internet connected device such as a phone,
    tablet, computer or any other device that can be used to visit
    Receipthub and use the services.`,
      `  -Service: refers to the service provided by Receipthub as
    ...
    content or whose products or services we think may interest you.`,
      `  -Website: Receipthub."’s" site, which can be accessed via
    this URL: www.receipthub.co.uk`,
      `  -You: a person or entity that is registered with Receipthub
    to use the Services.`,
    ],
  },
  {
  ...
  website/app or make the platform available to any third party.`,
    ...
    reverse compile or reverse engineer any part of the website/app.`,
      ...
      any notice of copyright or trademark) of Receipthub or its affiliates,
  ...
  },
  {
    ...
    value: [
      `Thanks for shopping at Receipthub. We appreciate the fact that you like
  ...
  our products.`,
    ...
    apply to transactions at Receipthub. We’ll be as brief as our attorneys
    will allow. The main thing to remember is that by placing an order or
    making a purchase at Receipthub, you agree to the terms along with
    Receipthub."’s" Privacy Policy.`,
  ...
  },
  {
    ...
    (collectively, "Suggestions") provided by you to Receipthub with respect
    to the website/app shall remain the sole and exclusive property of
    Receipthub.`,
      `Receipthub shall be free to use, copy, modify, publish, or redistribute
  ...
  },
  {
    ...
    Receipthub. We are not responsible for the content, accuracy or opinions
  ...
  },
  {
    title: 'Cookies',
    value: [
      `Receipthub uses "Cookies" to identify the areas of our website that you
  ...
  },
  {
    ...
    value: [
      `You acknowledge and agree that <?=Receipthub;?> may stop
      (permanently or temporarily) providing the Service (or any features
      within the Service) to you or to users generally at
      <?=Receipthub;?>’s sole discretion, without prior notice to you.
      You may stop using the Service at any time. You do not need to
      specifically inform <?=Receipthub;?> when you stop using the
      Service. You acknowledge and agree that if <?=Receipthub;?>
  ...
  },
  {
    ...
    value: [
      `Receipthub reserves the right to modify, suspend or discontinue,
  ...
  },
  {
    ...
    value: [
      `Receipthub may from time to time provide enhancements or improvements to
    ...
    ("Updates").`,
      ...
      the website/app. You agree that Receipthub has no obligation to (i)
  ...
  },
  {
    ...
    value: [
      ...
      `You acknowledge and agree that Receipthub shall not be responsible for
      ...
      or any other aspect thereof. Receipthub does not assume and shall not
  ...
  },
  {
    ...
    value: [
     ...
     Receipthub.`,
      `Receipthub may, in its sole discretion, at any time and for any or no
      ...
      Receipthub, in the event that you fail to comply with any provision of
      ...
      `Termination of this Agreement will not limit any of Receipthub's rights
  ...
  },
  {
    ...
    value: [
      ` You agree to indemnify and hold Receipthub and its parents,
  ...
  },
  {
    ...
    value: [
     ...
     extent permitted under applicable law, Receipthub, on its own behalf and
     ...
     practice. Without limitation to the foregoing, Receipthub provides no
     ...
     or will be corrected.`,
      ` Without limiting the foregoing, neither Receipthub nor any Receipthub's
      ...
      servers, the content, or e-mails sent from or on behalf of Receipthub
  ...
  },
  {
    ...
    of Receipthub and any of its suppliers under any provision of this
    ...
    limited to the amount actually paid by you for the website/app.`,
      ...
      Receipthub or its suppliers be liable for any special, incidental,
      ...
      of this Agreement), even if Receipthub or any supplier has been advised
  ...
  },
  {
    ...
    and effect.`,
      ...
      notices published by Receipthub on the Services, shall constitute the
      entire agreement between you and Receipthub concerning the Services. If
      ...
      any other term, and Receipthub."’s" failure to assert any right or
      provision under this Agreement shall not constitute a waiver of such
      right or provision. YOU AND Receipthub AGREE THAT ANY CAUSE OF ACTION
  ...
  },
  {
    ...
    value: [
      `Receipthub reserves the right, at its sole discretion, to modify or
  ...
  },
  {
    ...
    Receipthub regarding your use of the website/app and supersedes all
    ...
    Receipthub.`,
      ...
      you use or purchase other Receipthub's services, which Receipthub will
  ...
  },
  {
    ...
    value: [
      ...
      thereof), are owned by Receipthub, its licensors or other providers of
      such material and are protected by United Kingdom and international
      ...
      in part, without the express prior written permission of Receipthub,
  ...
  },
  {
    ...
    value: [
      ...
      ENFORCEMENT OR VALIDITY OF YOUR OR Receipthub."’s" INTELLECTUAL PROPERTY
      RIGHTS. The term “dispute” means any dispute, action, or other
      controversy between you and Receipthub concerning the Services or this
  ...
  },
  {
    ...
    value: [
      `In the event of a dispute, you or Receipthub must give the other a
      ...
      Notice of Dispute via email to: admin@receipthub.com. Receipthub will
      send any Notice of Dispute to you by mail to your address if we have it,
      or otherwise to your email address. You and Receipthub will attempt to
      ...
      or Receipthub may commence arbitration.`,
    ],
  },
  {
    title: 'Binding Arbitration',
    value: [
      `If you and Receipthub don’t resolve any dispute by informal negotiation,
  ...
  },
  {
    ...
    value: [
      ...
      and will become the sole property of Receipthub without any compensation
      or credit to you whatsoever. Receipthub and its affiliates shall have no
  ...
  },
  {
    title: 'Promotions',
    value: [
      `Receipthub may, from time to time, include contests, promotions,
  ...
  },
  {
    ...
    value: [
      ...
      of Receipthub. Receipthub will be entitled to injunctive or other
      equitable relief (without the obligations of posting any bond or surety)
      in the event of any breach or anticipatory breach by you. Receipthub
      operates and controls the Receipthub Service from its offices in United
      Kingdom. The Service is not intended for distribution to or use by any
      ...
      persons who choose to access the Receipthub Service from other locations
      ...
      Terms & Conditions (which include and incorporate the Receipthub Privacy
      Policy) contains the entire understanding, and supersedes all prior
      understandings, between you and Receipthub concerning its subject
  ...
  },
  {
    title: 'Disclaimer',
    value: [
      `Receipthub is not responsible for any content, code or any other
      imprecision.`,
      `Receipthub does not provide warranties or guarantees.`,
      `In no event shall Receipthub be liable for any special, direct,
      ...
      contents of the Service. Receipthub reserves the right to make
      additions, deletions, or modifications to the contents on the Service at
      any time without prior notice.`,
      `The Receipthub Service and its contents are provided "as is" and "as
      available" without any warranty or representations of any kind, whether
      express or implied. Receipthub is a distributor and not a publisher of
      the content supplied by third parties; as such, Receipthub exercises no
      ...
      accessible via the Receipthub Service. Without limiting the foregoing,
      Receipthub specifically disclaims all warranties and representations in
      any content transmitted on or in connection with the Receipthub Service
      or on sites that may appear as links on the Receipthub Service, or in
      the products provided as a part of, or otherwise in connection with, the
      Receipthub Service, including without limitation any warranties of
      merchantability, fitness for a particular purpose or non-infringement of
      third party rights. No oral advice or written information given by
      Receipthub or any of its affiliates, employees, officers, directors,
      ...
      foregoing, Receipthub does not warrant that the Receipthub Service will
  ...
  },
  {
    ...
    value: [
      ...
      ` -Via Email: admin@receipthub.com`,
    ],
  },
];
